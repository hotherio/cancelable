...
class SectionExtractor:
    ...
    def __init__(self, file_path: Path):
        ...
        self._sections: Optional[Dict[str, List[CodeSection]]] = None
    ...
    def get_section(self, name: str) -> Optional[CodeSection]:
    ...
    def merge_sections(self, names: List[str]) -> Optional[str]:
