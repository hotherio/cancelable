...
GITHUB_REPO = "hotherio/cancelable"
GITHUB_BRANCH = "main"


def get_github_link(file_path: str, start_line: Optional[int] = None, end_line: Optional[int] = None) -> str:
...
def resolve_file_path(path: str, base_dir: Optional[Path] = None) -> Optional[Path]:
